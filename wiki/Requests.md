...
**Nestjsx/crud** provides a full range of path and query parameters parsing/validation to help you build rich RESTful APIs. [**@nestjsx/crud-request**](https://www.npmjs.com/package/@nestjsx/crud-request) is responsible for that.
...
[**@nestjsx/crud-request**](https://www.npmjs.com/package/@nestjsx/crud-request) is a framework agnostic package that has been designed for both backend and frontend usage. It's also used by [**@nestjsx/crud**](https://www.npmjs.com/package/@nestjsx/crud) package in `CrudRequestInterceptor`.
