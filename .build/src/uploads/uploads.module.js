...
var import_uploads2 = __toModule(require("./uploads.controller"));
var import_upload = __toModule(require("./entities/upload.entity"));
let UploadsModule = class {
};
UploadsModule = __decorateClass([
  (0, import_common.Module)({
    imports: [import_typeorm.TypeOrmModule.forFeature([import_upload.Upload])],
    controllers: [import_uploads2.UploadsController],
